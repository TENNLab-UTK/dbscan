/* This program reads the processor_tool output of a systolic dbscan neural network, 
   running on a partial input grid, and prints the grid of labeled events. */
...
int main(int argc, char **argv)
{
  ...
  if (argc != 3) {
    fprintf(stderr, "usage: bin/output_systolic_partial e I_C\n");
    exit(1);
  }
